...
public class BridgeProblem extends Problem {
    ...
    public BridgeProblem() {
        finalState = new BridgeState(Position.EAST,
                                    Position.EAST,
                                    Position.EAST,
                                    Position.EAST,
                                    Position.EAST,
                                    17);
        currState = new BridgeState(Position.WEST, // P1 |   |
                                    Position.WEST, // P2 |   |
                                    Position.WEST, //  f |===|
                                    Position.WEST, // P5 |   |
                                    Position.WEST, // P10|   |
        ...
        intro = ("Welcome to the Bridge Crossing Problem.\n\n" +
    ...
    public boolean success() {
        ...
        if (currentState.equals(new BridgeState(Position.EAST, Position.EAST,
                Position.EAST, Position.EAST, Position.EAST, 17)) 
    ...
    private BridgeState currState, finalState;
