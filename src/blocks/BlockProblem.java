...
public class BlockProblem extends Problem {
    ...
    public BlockProblem() {
        ...
        initialCanvases.add(new BlockCanvasIcon(start1));
        initialCanvases.add(new BlockCanvasIcon(start2));
        initialCanvases.add(new BlockCanvasIcon(start3));
        initialCanvases.add(new BlockCanvasIcon(start4));
        initialCanvases.add(new BlockCanvasIcon(start5));
        initialCanvases.add(new BlockCanvasIcon(start6));
        initialCanvases.add(new BlockCanvasIcon(start7));

        finalCanvases.add(new BlockCanvasIcon(final1));
        finalCanvases.add(new BlockCanvasIcon(final2));
        finalCanvases.add(new BlockCanvasIcon(final3));
        finalCanvases.add(new BlockCanvasIcon(final4));
        finalCanvases.add(new BlockCanvasIcon(final5));
        finalCanvases.add(new BlockCanvasIcon(final6));
        finalCanvases.add(new BlockCanvasIcon(final7));
